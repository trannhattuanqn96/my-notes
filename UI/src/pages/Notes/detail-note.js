                ...
                <div className="p-40 md:px-20 px-4  ">
                    ...
                    <div className="border-[1px] bg-[#1a1a1a] rounded-[1rem] shadow-md p-[20px] ">
                        ...
                        {detailNote === null ? null : (
                            ...
                            <div className="text-white [&_table]:border-1  [&_table>tbody>tr]:border-1 [&_table>tbody>tr>td]:border-1 [&_p]:!my-5 [&_p]:!leading-10 [&_ul]:!leading-10 [&_ol]:!list-disc [&_ul]:!list-disc [&_ol>li]:!ml-5 [&_ul>li]:!ml-5">{parse(detailNote?.content)}</div>
                        )}
                    </div>
                </div>
            </div>
